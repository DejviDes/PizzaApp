        ...
        <footer className={styles.footerContainer}>
            <div className={styles.footerContent}>
                <div className={styles.gridContainer}>
                    ...
                    <div>
                        <h2 style={{margin: "1.5rem 0"}} className={styles.sectionTitle}>NAVIGATION</h2>
                    ...
                    <div>
                        <h2 style={{margin: "1.5rem 0"}} className={styles.sectionTitle}>DISHES</h2>
                        <ul className={styles.list}>
                    ...
                    <div>
                        <h2 style={{margin: "1.5rem 0"}} className={styles.sectionTitle}>FOLLOW US</h2>
